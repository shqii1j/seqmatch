    ...
    for k, inter in enumerate(intervals):
        ...
        for it in range(0, args.Iteration+1):
            ...
            if it in eval_it_pool and (save_this_it or it % 1000 == 0):
                with torch.no_grad():
                    save_dir = os.path.join(args.save_dir, args.dataset, args.run_name, seg_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='./logged_files', help='the image path of the previous subsets')
    ...
    parser.add_argument('--intervals', type=str, default=None,
                        help='* the intervals of the teacher trajectories we need to match')
