...
def get_dataset(dataset, data_path, batch_size=1, subset="imagenette", args=None, record=False):
    ...
    if dataset == 'CIFAR10':
        ...
        dst_train = datasets.ImageFolder(os.path.join(data_path+"/imagenet", "train"), transform=transform) # no augmentation
        ...
        dst_test = datasets.ImageFolder(os.path.join(data_path+"/imagenet", "val"), transform=transform)
